...
namespace RPG.Textures2D
{
    public class MyTexture
    {
        ...
        public static MyTexture CoinBronzeSmall = new MyTexture(@"art\pickup\pickup_coin_bronze_small_8", new Rectangle(0, 0, 8, 8), 0.54f, 6, animationSpeed: COINS_ANIMATION_SPEED);
        public static MyTexture CoinSilverSmall = new MyTexture(@"art\pickup\pickup_coin_silver_small_8", new Rectangle(0, 0, 8, 8), 0.54f, 6, animationSpeed: COINS_ANIMATION_SPEED);
        public static MyTexture CoinGoldSmall = new MyTexture(@"art\pickup\pickup_coin_gold_small_8", new Rectangle(0, 0, 8, 8), 0.54f, 6, animationSpeed: COINS_ANIMATION_SPEED);
        public static MyTexture CoinBronze = new MyTexture(@"art\pickup\pickup_coin_bronze_16", new Rectangle(0, 0, 16, 16), 0.54f, 6, animationSpeed: COINS_ANIMATION_SPEED);
        public static MyTexture CoinSilver = new MyTexture(@"art\pickup\pickup_coin_silver_16", new Rectangle(0, 0, 16, 16), 0.54f, 6, animationSpeed: COINS_ANIMATION_SPEED);
        public static MyTexture CoinGold = new MyTexture(@"art\pickup\pickup_coin_gold_16", new Rectangle(0, 0, 16, 16), 0.54f, 6, animationSpeed: COINS_ANIMATION_SPEED);
        public static MyTexture GemEmerald = new MyTexture(@"art\pickup\pickup_gem_emerald_12", new Rectangle(0, 0, 12, 12), 0.54f, 7, animationSpeed: COINS_ANIMATION_SPEED);
        public static MyTexture GemRuby = new MyTexture(@"art\pickup\pickup_gem_ruby_12", new Rectangle(0, 0, 12, 12), 0.54f, 7, animationSpeed: COINS_ANIMATION_SPEED);
        public static MyTexture GemDiamond = new MyTexture(@"art\pickup\pickup_gem_diamond_24", new Rectangle(0, 0, 24, 24), 0.54f, 14, animationSpeed: COINS_ANIMATION_SPEED);
